...
//		public const string	AllTurnEnd = "AllTurnEnd";
	...
	public struct UnitSpeed{
		public static float NORMAL_PATROL = 5.3f;//MOVE_PATROL
		public static float NORMAL_SPEED = 5.3f;
	}
	...
	//ユニットの普段な冷却時間
	public const float UNIT_COMMON_DOOLDOWN = 1f;

	public const float COOLDOWN_OFFSET = 0.1f;

	public const float SKILL_CHECK_DISTANCE_OFFSET = 1;

	public const float DEFAULT_AI_SKILL_SCANE_INTERVAL = 0.1f;

	public const int MAX_SCANE_ABLE_COUNT = 10;

	public const float MAX_IDLE_DURATION = 3;

	public const string DEFAULT_MONSTER_PREFAB = "Units/DefaultMonster";

	public const float UNIT_ACTIVE_DELAY = 2;

	public const float MIN_STOP_DISTANCE = 0.5f;
