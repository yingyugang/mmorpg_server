...
//TODO UNET的数据类型的基本size并没有看到，最好能找到类似photon的数据类型的size说明。这样就能对数据大小进行准确的规划。
namespace MMO
{
	public class HitInfoArray:MessageBase{
		public HitInfo[] hitInfos;
		public HitInfoArray(){
			hitInfos = new HitInfo[0];
		}
	}
	//TODO
	[Serializable]
	...
	[Serializable]
	public class ShootInfoArray:MessageBase{
		public ShootInfo[] shootInfos;
		public ShootInfoArray(){
			shootInfos = new ShootInfo[0];
		}
	}
...
//		public string chat;
	...
	[System.Serializable]
	public class MMOTransformArray :MessageBase{
		public MMOTransform[] transforms;
		public MMOTransformArray(){
			transforms = new MMOTransform[0];
		}
	}
